...
def loadData():
	...
	for i in range(1,len(lines)):
		...
		m=line[0].strip();
		tests_1=line[1].split(";");
		tests_2=line[2].split(";");
		tests_3 = line[3].split(";")
		tests_1 = [i for i in tests_1 if i != 'Empty'];
		tests_2 = [i for i in tests_2 if i != 'Empty'];
		tests_3 = [i for i in tests_3 if i != 'Empty'];
		mutants[m]=[tests_1,tests_2,tests_3];
	return mutants;
...
for mi in all_mutants:
	...
	writer_D0_matrix.write(",".join(temp_3) + "\n")
